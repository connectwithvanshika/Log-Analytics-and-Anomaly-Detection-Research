...
Medium blog - [https://medium.com/venkataprakhya7/building-an-anomaly-detection-system-using-data-science-machine-learning-and-ai-7aa18aaf4af5]

| Blog Project     | Your Project                         |
| ---------------- | ------------------------------------ |
| Raw Data         | Log Data                             |
| Data Cleaning    | Log Parsing + Preprocessing          |
| Isolation Forest | Isolation Forest / LOF / Autoencoder |
| Detect Anomaly   | Detect Anomaly                       |
| Visualization    | Context Generation                   |
| END              | LLM Analysis                         |
| END              | Root Cause Analysis                  |
| END              | Recommendations                      |
| END              | Observability Dashboard              |
